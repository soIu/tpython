/* ported by Ceri Storey  - Derived from 'Lib/test/pystone.py' from the Python software distribution. 
...
function main(loops) {
    ...
    console.log("This machine benchmarks at " + stones + " pystones/second");
}
