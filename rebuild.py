...
VMLIB_FILES=tp.gen.cpp dummy-compiler.cpp runtime.gen.cpp blendot/mutex.cpp blendot/memory.cpp blendot/pool_allocator.cpp blendot/pool_vector.cpp blendot/message_queue.cpp blendot/object.cpp blendot/node_path.cpp blendot/ip_address.cpp blendot/class_db.cpp blendot/resource.cpp blendot/method_bind.cpp blendot/reference.cpp blendot/ref_ptr.cpp blendot/array.cpp blendot/variant_op.cpp blendot/variant.cpp blendot/string_name.cpp blendot/print_string.cpp blendot/core_string_names.cpp blendot/dictionary.cpp blendot/ustring.cpp blendot/math_funcs.cpp blendot/basis.cpp blendot/vector2.cpp blendot/vector3.cpp blendot/quat.cpp blendot/color.cpp blendot/aabb.cpp blendot/transform.cpp blendot/transform_2d.cpp blendot/rid.cpp blendot/scene/main/scene_tree.cpp blendot/scene/main/node.cpp blendot/scene/3d/spatial.cpp blendot/scene/scene_string_names.cpp blendot/main_loop.cpp blendot/engine.cpp blendot/scene/resources/material.cpp blendot/scene/resources/mesh.cpp blendot/scene/resources/surface_tool.cpp blendot/face3.cpp blendot/plane.cpp blendot/scene/resources/shape.cpp blendot/quick_hull.cpp blendot/scene/resources/convex_polygon_shape.cpp blendot/scene/resources/concave_polygon_shape.cpp blendot/triangle_mesh.cpp blendot/servers/visual_server.cpp blendot/image.cpp blendot/geometry.cpp blendot/servers/visual/visual_server_raster.cpp blendot/servers/visual/visual_server_globals.cpp <MODULES>
